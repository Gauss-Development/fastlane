...
const (
	...
	AuthService_IssueMagicLinkToken_FullMethodName    = "/auth.v1.AuthService/IssueMagicLinkToken"
	AuthService_ValidateMagicLinkToken_FullMethodName = "/auth.v1.AuthService/ValidateMagicLinkToken"
...
type AuthServiceClient interface {
	...
	IssueMagicLinkToken(ctx context.Context, in *IssueMagicLinkTokenRequest, opts ...grpc.CallOption) (*IssueMagicLinkTokenResponse, error)
	ValidateMagicLinkToken(ctx context.Context, in *ValidateMagicLinkTokenRequest, opts ...grpc.CallOption) (*ValidateMagicLinkTokenResponse, error)
...
func (c *authServiceClient) IssueMagicLinkToken(ctx context.Context, in *IssueMagicLinkTokenRequest, opts ...grpc.CallOption) (*IssueMagicLinkTokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IssueMagicLinkTokenResponse)
	err := c.cc.Invoke(ctx, AuthService_IssueMagicLinkToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) ValidateMagicLinkToken(ctx context.Context, in *ValidateMagicLinkTokenRequest, opts ...grpc.CallOption) (*ValidateMagicLinkTokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ValidateMagicLinkTokenResponse)
	err := c.cc.Invoke(ctx, AuthService_ValidateMagicLinkToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	IssueMagicLinkToken(context.Context, *IssueMagicLinkTokenRequest) (*IssueMagicLinkTokenResponse, error)
	ValidateMagicLinkToken(context.Context, *ValidateMagicLinkTokenRequest) (*ValidateMagicLinkTokenResponse, error)
...
func (UnimplementedAuthServiceServer) IssueMagicLinkToken(context.Context, *IssueMagicLinkTokenRequest) (*IssueMagicLinkTokenResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method IssueMagicLinkToken not implemented")
}
func (UnimplementedAuthServiceServer) ValidateMagicLinkToken(context.Context, *ValidateMagicLinkTokenRequest) (*ValidateMagicLinkTokenResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ValidateMagicLinkToken not implemented")
}
...
func _AuthService_IssueMagicLinkToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IssueMagicLinkTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).IssueMagicLinkToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_IssueMagicLinkToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).IssueMagicLinkToken(ctx, req.(*IssueMagicLinkTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AuthService_ValidateMagicLinkToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ValidateMagicLinkTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).ValidateMagicLinkToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_ValidateMagicLinkToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).ValidateMagicLinkToken(ctx, req.(*ValidateMagicLinkTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "IssueMagicLinkToken",
			Handler:    _AuthService_IssueMagicLinkToken_Handler,
		},
		{
			MethodName: "ValidateMagicLinkToken",
			Handler:    _AuthService_ValidateMagicLinkToken_Handler,
		},
		{
