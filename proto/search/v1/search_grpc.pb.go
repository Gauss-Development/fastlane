...
func (c *searchServiceClient) HealthCheck(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedSearchServiceServer) HealthCheck(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
