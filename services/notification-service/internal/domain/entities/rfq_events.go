...
const (
	NotificationTypeRFQCreated     NotificationType = "rfq_created"
	NotificationTypeQuoteSubmitted NotificationType = "quote_submitted"
)

// RFQSupplierInvite mirrors post-service's rfq.created payload entry for one
// invited supplier (contact + pre-minted magic link).
